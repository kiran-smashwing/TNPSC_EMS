                ...
                <div class="card my-5">
                    <div class="card-body">
                        <div class="text-center">
                            <a href="#"><img src="../storage/assets/images/logo-dark.png" style="max-width: 340px;"
                                    alt="img" /></a>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <input name="lname" type="text" class="form-control" placeholder="Last Name" value="{{ old('lname') }}" required />
                                        @error('lname')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="d-flex mt-1 justify-content-between">
                                <div class="form-check">
                                    <input name="termsAndConditions" class="form-check-input input-primary" type="checkbox" id="customCheckc1" />
