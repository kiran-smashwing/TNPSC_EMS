                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h5 class="mb-3 mb-sm-0">Cheif Invigilator list</h5>
                            <div>
                                <a href="{{route('cheif_invigilator.create')}}" class="btn btn-outline-success">Add Cheif Invigilator</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('cheif_invigilator.edit') }}" class="avtar avtar-xs  btn-light-success"><i class="ti ti-edit f-20"></i></a>
