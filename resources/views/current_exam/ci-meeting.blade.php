                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="mt-2">
                                                        <a href="{{route('current-exam.ciReceiveMaterials')}}" class="me-2 btn btn-sm btn-light-primary"><i
                                                                class="feather icon-aperture mx-1"></i>Scan</a>
                                                        <a href="#" data-pc-animate="just-me"
                                                            data-bs-toggle="modal" data-bs-target="#meetingPreliminaryCheckListModel"
