                ...
                <div class="tab-content">
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exam_main_type"
                                                    name="exam_main_type" disabled
                                                    value="{{ $exam->exam_main_type }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exam_main_model"
                                                    name="exam_main_model" disabled
                                                    value="{{ $exam->exam_main_model }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exam_main_tiers"
                                                    name="exam_main_tiers" disabled
                                                    value="{{ $exam->exam_main_tiers }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                <label class="form-label" for="exam_main_notification">Notification no</label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                <label class="form-label" for="exam_main_notifdate">Notification Date</label>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exam_main_name"
                                                    name="exam_main_name" disabled
                                                    value="{{ $exam->exam_main_name }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="exam_main_nametamil">Exam Name in Tamil</label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                <label class="form-label" for="exam_main_lastdate">Last Date For Apply</label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="mb-3">
                                                <label class="form-label" for="exam_main_startdate">Exam Start Date</label>
                                            ...
                                            @foreach ($exam->examsession as $index => $exam_session)
                                                <tr>
                                                    ...
                                                    <td data-label="Session">
                                                        <input type="text" name="subjects[{{ $index }}][session]"
                                                            class="form-control" value="{{ $exam_session->exam_sess_session }}" disabled />
                                                    </td>
                                                    <td data-label="Time">
                                                        <input type="text" name="subjects[{{ $index }}][time]"
                                                            class="form-control" value="{{ $exam_session->exam_sess_time }}" disabled />
                                                    </td>
                                                    <td data-label="Duration">
                                                        <input type="text" name="subjects[{{ $index }}][duration]"
                                                            class="form-control" value="{{ $exam_session->exam_sess_duration }}" disabled />
                                                    </td>
                                                    <td data-label="Subject">
                                                        <input type="text" name="subjects[{{ $index }}][name]"
                                                            class="form-control" value="{{ $exam_session->exam_sess_subject }}" disabled />
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                        ...
                        <div class="col-12 text-end btn-page">
                            <a href="{{ route('current-exam.index') }}" class="btn btn-outline-secondary">Back</a>
                        </div>
                    </div>
                </div>
            </div>
