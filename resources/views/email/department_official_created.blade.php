...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <ul>
                <strong>மின்னஞ்சல்: </strong>{{ $official_email }}
                <strong>கடவுச்சொல்:</strong>{{ $password }}
                <strong>கடவுச்சொல்:</strong>{{ $role }}
            </ul>
            ...
            <a href="{{ $playstore_link }}">TNPSC EMS செயலி பதிவிறக்கம் செய்ய இங்கே கிளிக் செய்யவும்</a>
