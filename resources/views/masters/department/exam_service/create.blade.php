            ...
            <div class="row">
              ...
              <div class="card-body py-0">
                ...
                <div class="tab-content">
                    <div>
                        <div class="row">
                            <form action="{{ route('exam-services.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if (session('success'))
                                            ...
                                            <div class="col-sm-6">
                                              <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                                  name="name" placeholder="GROUP I SERVICES EXAMINATION"
                                                  required>
                                                @error('name')
                                            ...
                                            <div class="col-sm-6">
                                              <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control @error('code') is-invalid @enderror" id="code"
                                                  name="code" placeholder="001" required>
                                                @error('code')
                                                  <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                              </div>
