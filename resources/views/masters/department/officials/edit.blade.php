    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="row">
                ...
                <form action="{{ route('department.officials.update', $official->dept_off_id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-control" id="dept_off_role" name="dept_off_role"
                                                            required>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="dept_off_name"
                                                            name="dept_off_name"
                                                            value="{{ old('dept_off_name', $official->dept_off_name) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ old('dept_off_emp_id', $official->dept_off_emp_id) }}"
                                                            id="dept_off_emp_id" name="dept_off_emp_id"
                                                            placeholder="EMP1234" required>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="dept_off_designation">Designation
                                                            <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                            value="{{ old('dept_off_designation', $official->dept_off_designation) }}"
                                                            id="dept_off_designation" name="dept_off_designation"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" class="form-control"
                                                            value="{{ old('dept_off_email', $official->dept_off_email) }}"
                                                            id="dept_off_email" name="dept_off_email"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="tel" class="form-control"
                                                            value="{{ old('dept_off_email', $official->dept_off_phone) }}"
                                                            id="dept_off_phone" name="dept_off_phone"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="password"
                                                            ...
                                                            id="dept_off_password" name="dept_off_password">
                                                        @error('password')
