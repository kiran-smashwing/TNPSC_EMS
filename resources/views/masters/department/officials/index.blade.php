                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a href="{{route('department.create')}}" class="btn btn-outline-success">Add Department Officials</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body table-border-style">
                        ...
                        <h6 class="mb-0">Airi Satou</h6>
                                    ...
                                    <td>CI</td>
                                    <td>District Collectorates Officer</td>
                                    <td>Testing@gmail.com</td>
                                    <td>+91-9094500072</td>
                                    <td class="text-center"><i class="ti ti-circle-check text-success f-18"></i></td>
                                    <td>
                                        <a href="{{ route('department.show') }}" class="avtar avtar-xs  btn-light-success"><i class="ti ti-eye f-20"></i></a>
                                        <a href="{{ route('department.edit') }}" class="avtar avtar-xs  btn-light-success"><i class="ti ti-edit f-20"></i></a>
