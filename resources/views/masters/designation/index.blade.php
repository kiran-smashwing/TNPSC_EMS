    ...
    <section class="pc-container">
        <div class="pc-content">
          ...
          <div class="col-md-10 col-xxl-9 mb-4">
                ...
                <p class="text-muted">A lightweight, extendable, JavaScript HTML table library written in TypeScript and
                    transpilled to Vanilla JavaScript. Similar to jQuery DataTables for use in modern browsers, but without
