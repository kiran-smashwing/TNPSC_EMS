                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control @error('district') is-invalid @enderror"
                                                        ...
                                                        @foreach ($districts as $district)
                                                            <option value="{{ $district->district_code }}"
                                                                {{ old ('district', $ciAssistant->cia_district_id) == $district->district_code ? 'selected' : '' }}>
                                                    ...
                                                    @if (session('auth_role') == 'venue' || session('auth_role') == 'ci')
                                                            <input type="hidden" name="district"
                                                                value="{{ $ciAssistant->cia_district_id }}">
                                                        @endif
                                                    @error('district')
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" name="center"
                                                        value="{{ $ciAssistant->cia_center_id }}">
                                                @endif
                                                    @error('center')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    @if (session('auth_role') == 'venue' || session('auth_role') == 'ci')
                                                            <input type="hidden" name="venue"
                                                                value="{{ $ciAssistant->cia_venue_id }}">
                                                        @endif
                                                    @error('venue')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
        ...
        <script>
            ...
            $('#district').on('change', function() {
                ...
                filteredCenters.forEach(center => {
                    const selected = "{{ old ('center', $ciAssistant->cia_center_id) }}" == center.center_code ? 'selected' : '';
            ...
            $(document).ready(function() {
                const oldDistrict = "{{ old ('district', $ciAssistant->cia_district_id) }}";
                if (oldDistrict) {
        ...
        <script>
            ...
            $('#center').on('change', function() {
                ...
                filteredVenues.forEach(venue => {
                    const selected = "{{ old ('venue', $ciAssistant->cia_venue_id) }}" == venue.venue_code ? 'selected' : '';
            ...
            // Trigger change event on page load to handle old/existing selections
            $(document).ready(function() {
                const oldCenter = "{{ old ('center', $ciAssistant->cia_center_id ?? '') }}";
                if (oldCenter) {
