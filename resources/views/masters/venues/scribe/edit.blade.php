        ...
        <div class="pc-content">
            ...
            <div class="row">
                ...
                <div class="tab-content">
                    <div>
                        <form action="{{ route('scribes.update', $scribe->scribe_id) }}" method="POST"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="hidden" name="district"
                                                            value="{{ $scribe->scribe_district_id }}">
                                                    @endif
                                                        @error('district')
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="name" value="{{ old('name', $scribe->scribe_name) }}"
                                                ...
                                                {{-- <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email"
                                                            ...
                                                            id="mail"
                                                            value="{{ old('mail', $scribe->scribe_email) }}"
                                                            name="mail" placeholder="malarvizhi@***.in" required>
                                                        @error('mail')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="tel"
                                                            ...
                                                            id="phone"
                                                            value="{{ old('phone', $scribe->scribe_phone) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            value="{{ old('designation', $scribe->scribe_designation) }}"
        ...
        <script>
            ...
            $('#center').on('change', function() {
                ...
                filteredVenues.forEach(venue => {
                    const selected = "{{ old('venue', $scribe->scribe_venue_id) }}" == venue.venue_id ? 'selected' : '';
