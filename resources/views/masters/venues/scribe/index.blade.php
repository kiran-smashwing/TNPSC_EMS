                                ...
                                <tbody>
                                    @foreach ($scribes as $scribe)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0">
                                                        <img src="{{ $scribe->scribe_image ? asset('storage/' . $scribe->scribe_image) : asset('assets/images/user/avatar-1.jpg') }}"
                                            ...
                                            <td></td>
                                            <td>
                                                <a href="{{ route('scribe.show', $scribe->scribe_id) }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            toggleButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    // Get the scribe ID from the data attribute
                    const scribeId = this.dataset.scribeId;

                    // Send the request to toggle the status
                    fetch(`{{ url('/') }}/scribe/${scribeId}/toggle-status`, {
                            method: 'POST',
                            headers: {
