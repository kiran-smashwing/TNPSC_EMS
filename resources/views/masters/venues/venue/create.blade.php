                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label " for="name">Venue Name<span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control @error('venue_name') is-invalid @enderror" id="venue_name"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    <label class="form-label ">Venue Code<span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" class="form-control no-arrows @error('venue_code') is-invalid @enderror" id="venue_code"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control @error('venue_code_provider') is-invalid @enderror" id="venue_code_provider"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="distance_from_railway">Distance from Railway<span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" step="any" class="form-control @error('distance_from_treasury') is-invalid @enderror"
