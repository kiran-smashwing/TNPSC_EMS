                ...
                <div class="card">
                    ...
                    <div class="card-body table-border-style">
                        ...
                        <h6 class="mb-0">Airi Satou</h6>
                                    ...
                                    <td>
                                        <a href="{{ route('venue.show') }}" class="avtar avtar-xs  btn-light-success"><i class="ti ti-eye f-20"></i></a>
                                        <a href="{{ route('venue.edit') }}" class="avtar avtar-xs  btn-light-success"><i class="ti ti-edit f-20"></i></a>
