<div class="modal fade modal-animate" data-bs-backdrop="static" id="apdAddlCandidateCountModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('apd-candidates.addl-cand-count') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="exam_id" value="{{ $session->exam_main_no }}">
                <div class="modal-header">
                    <h5 class="modal-title">Upload Additional Candidates Count</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="{{route('apd-candidates.download-finalize-halls-sample-csv')}}" class="mb-2">Download Sample CSV </a>
                        <p class="mb-0">
                            <b>2. Supported File Format:</b> Only.csv files are supported for upload. Ensure your file
                            is saved with a .csv extension.
                        </p>
                        <p class="mb-0">
                        ...
                        <p class="mb-0">
                            ...
                            within the data fields as they may cause parsing errors.
                        </p>
                        <p class="mb-0">
