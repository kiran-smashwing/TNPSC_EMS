<div class="modal fade modal-animate" data-bs-backdrop="static" id="apdFinalizeCandidate" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('apd-candidates.finalize-csv') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="exam_id" value="{{ $session->exam_main_no }}">
                <div class="modal-header">
                    <h5 class="modal-title">Final Halls & Candidates</h5>
