...
<div class="modal fade modal-animate anim-blur" data-bs-backdrop="static" id="routeCreationModal" tabindex="-1"
    aria-labelledby="routeCreationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-primary" id="routeCreationModalLabel">
