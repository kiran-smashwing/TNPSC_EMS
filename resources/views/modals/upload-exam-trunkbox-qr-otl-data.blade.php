<div class="modal fade modal-animate" data-bs-backdrop="static" id="examTrunkboxQROTLUploadModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('exam-trunkbox-qr-otl-data.upload') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="exam_id" value="{{ $examId }}">
                <div class="modal-header">
                    <h5 class="modal-title">Upload Exam Trunk Box QR OTL Data</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="{{ route('exam-trunkbox-qr-otl-data.download-sample-csv') }}" class="mb-2">Download Sample CSV</a>
