<div class="modal fade modal-animate anim-blur" data-bs-backdrop="static" id="venueDetailsModal" tabindex="-1" aria-labelledby="venueDetailsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        ...
        <div class="modal-body">
          <div class="alert alert-warning" role="alert">
            ...
            Please check the address details carefully and make appropriate corrections. All fields marked with an asterisk (*) are required.
          </div>
          ...
          <form id="venueDetailsForm" method="POST" action="" autocomplete="off">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-6">
                ...
                <textarea class="form-control" name="venue_name" id="venue_name" rows="2" required></textarea>
              </div>
              
              <!-- Address Line 1 -->
              <div class="col-md-6">
                <label for="address_1" class="form-label">Address Line 1 *</label>
                <textarea class="form-control" name="address_1" id="address_1" rows="2" required></textarea>
              </div>
              ...
              <div class="col-md-4">
                ...
                <input type="email" class="form-control" name="cmail" id="cmail" required>
              </div>
              ...
              <div class="col-md-4">
                ...
                <input type="tel" class="form-control" name="CI_mobile" id="CI_mobile" required>
              </div>
              ...
              <div class="col-md-4">
                <label for="disbus" class="form-label">Distance from Bus Stand/Railway Station (KM) *</label>
                <input type="number" step="0.01" class="form-control" name="disbus" id="disbus" required>
              </div>
              
              <!-- Distance from Treasury -->
              <div class="col-md-4">
                <label for="dis_tressary" class="form-label">Distance from Treasury (KM) *</label>
                <input type="number" step="0.01" class="form-control" name="dis_tressary" id="dis_tressary" required>
              </div>
              
              <!-- Latitude -->
              <div class="col-md-4">
                <label for="latitute" class="form-label">Latitude *</label>
                <input type="number" step="0.000001" class="form-control" name="latitute" id="latitute" required>
              </div>
              
              <!-- Longitude -->
              <div class="col-md-4">
                <label for="langtitute" class="form-label">Longitude *</label>
                <input type="number" step="0.000001" class="form-control" name="langtitute" id="langtitute" required>
              </div>
