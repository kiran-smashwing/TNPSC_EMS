...
@section('title',
    session('auth_role') == 'mobile_team_staffs'
    ? 'Chief Invigilator to Mobile Team'
    : 'Chief Invigilator
    to Van Duty Staff')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h5 class="mb-3 mb-sm-0">Cheif Invigilators to
                                    {{ session('auth_role') == 'mobile_team_staffs' ? 'Mobile Team' : 'Van Duty Staff' }}
                                </h5>
                        ...
                        <div class="card-body table-border-style">
                            ...
                            <form id="filterForm" class="mb-3" method="GET"
                                action="{{ route('bundle-packaging.ci-to-mobileteam', ['examId' => $examId, 'examDate' => $examDate]) }}">
                                ...
                                <div class="btn-container">
                                    <button type="button" id="resetButton"
                                        ...
                                        onclick="window.location.href='{{ route('bundle-packaging.ci-to-mobileteam', ['examId' => $examId, 'examDate' => $examDate]) }}'">
