                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h5 class="mb-3 mb-sm-0">Headquarters to Van Duty Staff</h5>
                        ...
                        <div class="card-body table-border-style">
                            ...
                            <form id="filterForm" class="mb-3" method="GET"
                                action="{{ route('receive-exam-materials.headquarters-to-vanduty', ['examId' => $examId, 'examDate' => $examDate]) }}">
                                ...
                                <div class="btn-container">
                                    <button type="button" id="resetButton"
                                        ...
                                        onclick="window.location.href='{{ route('receive-exam-materials.headquarters-to-vanduty', ['examId' => $examId, 'examDate' => $examDate]) }}'">
    ...
    @push('scripts')
        ...
        <script>
            ...
            document.getElementById("submitScannedCodesBtn").addEventListener("click", function() {
                ...
                fetch("{{ route('receive-exam-materials.scan-vandutystaff-exam-materials', $examId) }}", {
                        method: 'POST',
                        headers: {
