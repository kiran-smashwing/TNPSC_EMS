...
@section('title', 'Materials From Printer to Headquarters')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                <h5 class="mb-3 mb-sm-0">Printer to Headquarters</h5>
    ...
    @push('scripts')
        ...
        <script>
            function processQrCode(data) {
                ...
                modalInstance.hide();
                fetch("{{ route('receive-exam-materials.scan-hq-exam-materials', $examId) }}", {
                        method: 'POST',
                        headers: {
