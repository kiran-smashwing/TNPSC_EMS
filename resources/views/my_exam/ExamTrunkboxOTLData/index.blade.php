...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            <h5 class="mb-3 mb-sm-0">Update Trunkbox QR & OTL Scan Details</h5>
                            <div>
                                <a href="#" class="btn btn-outline-success" data-pc-animate="just-me"
                                    data-bs-toggle="modal" data-bs-target="#examTrunkboxQROTLUploadModal">
    ...
    @include('modals.upload-exam-trunkbox-qr-otl-data')
    <!-- [ Main Content ] end -->
