...
@section('title', 'Exam Materials Discrepancy')
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Exam Materials Discrepancy</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form action="{{ route('exam-material-discrepancy.report') }}" method="GET">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="alertType" id="alertType" disabled class="form-control">
                                            
                                            <option value="Adequacy Check"
                                               selected>Discrepancy Alert
                                            </option>
                                        </select>
                                    </div>
