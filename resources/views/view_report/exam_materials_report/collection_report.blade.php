                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Collection Report</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Filter Collection Report</h5>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('collection-report.report.generate') }}" target="_blank" method="GET" id="filterForm">
                                @csrf
                                <div class="row">
                                    <!-- Notification No -->
