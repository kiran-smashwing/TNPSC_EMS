                                        ...
                                        @forelse ($attendance_data as $index => $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{asset('storage/reports/utilization-report/'.$exam_main_no.'/'.'utilization-report-'.$data['district_code'].'-'.$data['center_code'].'-'.$data['venue_code'].'-'.$data['hall_code'].'.pdf')}}"
